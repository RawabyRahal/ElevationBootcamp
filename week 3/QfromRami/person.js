...
// console.log("the fourthPerson is: " + fourthPerson.name.first)

// //  How many children does the 3rd Person have?
// console.log("number of childeren is: " + JSON.stringify(people[2].family.children.length))

// // 4. What Street does the 7th Person live on?
// console.log("The Street is: " + JSON.stringify(people[6].address.street))

// 5. How many people are over the age of 30 (Exclude the children)?
...
console.log("number of people over 30 is: " + count)

// 6. What is the avrg age of all the spouses?
let age = 0
let count2 = 0
for (let p of people) {
    // console.log(p.family)
    if (p.family.spouse != null) {
        age += p.family.spouse.age
        count2++
    }
}

console.log("the AVG is: " + (age / count))

// 7. How many people are there? (People, Spouses, Children)
let countP = 0
let countC = 0
for (let p of people) {
    if (p.family.spouse != null) {
...
console.log("The total number of people is: " + (people.length + countP + countC))